...
class App {
    ...
    constructor(private appInit: { port: number | string; middleWares: any; controllers: any; dbConnectionHandler: Function, dbURI: string, logger?: any, errorHandler: IErrorHandlerInterface }) {
        this.app = express()
        ...
        this.connectDatabase(appInit.dbConnectionHandler, appInit.dbURI)
    ...
    public connectDatabase(dbConnectionHandler: Function, dbURI: string) {
        dbConnectionHandler(dbURI)
    }
